use crate::{
    bulletin::{
        BulletinActionSubmitted, BulletinChanged, BulletinClosed, BulletinOpened,
    ...
    field_map::{FieldMapChanged, FieldMapClosed, FieldMapOpened, FieldMapSelectionSubmitted},
    group::{
...
pub(crate) enum ClientEvent {
    ...
    BulletinActionSubmitted(BulletinActionSubmitted),
    BulletinOperationResult(BulletinOperationCompleted),
...
impl ClientEvent {
    const fn name(&self) -> &'static str {
        match self {
            ...
            Self::FieldMapOpened(_) => "field_map.opened",
            ...
            Self::BulletinActionSubmitted(_) => "bulletin.action_submitted",
            Self::BulletinOperationResult(_) => "bulletin.operation_result",
    ...
    fn sequence(&self) -> u32 {
        match self {
            ...
            Self::FieldMapOpened(value) => value.observation.event_sequence,
            ...
            Self::BulletinActionSubmitted(value) => value.observation.event_sequence,
            Self::BulletinOperationResult(value) => value.observation.event_sequence,
